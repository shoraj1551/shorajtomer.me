...
import { ExternalLink, Github, Layers, Database, BookOpen } from "lucide-react";
import { ScrollAnimation } from "@/components/ui/scroll-animation";

export const metadata: Metadata = {
    title: "Projects | Shoraj Tomer",
    description: "Featured projects, platforms, and open source work by Shoraj Tomer.",
};
...
export default function ProjectsPage() {
    return (
        <div className="min-h-screen bg-white">
                    ...
                    {[
                        {
                            ...
                            tagline: "A modular LMS built for modular learning.",
                            description: "A comprehensive Learning Management System designed to break down complex engineering topics into digestible modules. Built with Next.js and a custom modular architecture to support interactive coding environments and progress tracking.",
                            tech: ["Next.js", "PostgreSQL", "Interactive Coding", "System Design"],
                            status: "Active Development",
                            icon: Layers
                        },
                        {
                            title: "Adaptive Test Engine",
                            tagline: "Validating skills through dynamic assessment.",
                            description: "An online testing platform that adapts to the user's skill level. It moves beyond simple multiple-choice questions to include code validation and scenario-based problem solving, providing a true measure of engineering capability.",
                            tech: ["React", "Node.js", "Real-time Analytics", "Adaptive Algorithms"],
                            status: "Beta",
                            icon: Database
                        }
                    ].map((project, i) => (
                        <ScrollAnimation key={i} className={`flex flex-col md:flex-row gap-12 items-center ${i % 2 === 1 ? 'md:flex-row-reverse' : ''}`}>
                            ...
                            {/* Placeholder for Project Image/Visual - Using a gradient div for now */}
            ...
            {/* 3. TEACHING & OPEN SOURCE RESOURCES */}
