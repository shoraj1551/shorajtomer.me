...
export async function PUT(
    ...
    try {
        ...
        const existingBlog = await blogService.getById(params.id)
        ...
        if (body.title && body.title !== existingBlog.title) {
            slug = await blogService.generateSlug(body.title, params.id)
        }

        const blog = await blogService.update(params.id, {
            ...body,
            slug,
...
export async function PATCH(
    ...
    try {
        ...
        const blog = await blogService.togglePublish(params.id)
