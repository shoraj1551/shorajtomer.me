...
export default function NewStoryPage() {
  ...
  const genres = [
    "Adventure", "Technology", "Business", "Lifestyle", "Education", 
    "Personal", "Travel", "Fiction", "Non-Fiction", "Mystery", "Romance"
  ]
  ...
  return (
    <AdminRoute>
      <div className="mx-auto max-w-4xl px-4 py-8 sm:px-6 lg:px-8">
        <div className="mb-8">
          <h1 className="text-3xl font-bold tracking-tight text-gray-900">Create New Story</h1>
          <p className="mt-2 text-lg text-gray-600">
            Share your experiences and insights through storytelling.
          </p>
        </div>
                ...
                <CardContent className="space-y-4">
                  ...
                  <div className="space-y-2">
                    ...
                    <p className="text-xs text-gray-500">
                      URL: /stories/{formData.slug || 'your-slug-here'}
                    </p>
                  </div>
                  ...
                  <div className="flex items-center justify-between">
                    <div className="space-y-0.5">
                      ...
                      <div className="text-sm text-gray-500">
                        Make this story visible to readers
                      </div>
                    </div>
                    <Switch
